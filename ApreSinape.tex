...
\section{5. Results \& Application}\label{results-application}
...
\item
  \textbf{Credible Intervals:} True spatial parameters are captured
  within 90\% Bayesian credible intervals (5\% and 95\% quantiles).
\item
  \textbf{Spacial Trajectory:} Seed positions walk stochastically and
