---
title: "Markov Random Fields with Spatial Seeds"
...
0. **Initialization**: Noise parameters $(\mu_k, \sigma^2)$ are calculated via K-means over the observed intensity $Y_i$ and they are used among the spatial parameters prioris to generate the initial $Z^{(0)}$ hidden field.
